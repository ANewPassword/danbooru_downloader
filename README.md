...
- 本工具仅供学习和研究使用。使用本工具进行下载可能违反目标网站的服务条款，由此导致的账户被限制、封禁或其他任何后果，作者概不负责，风险由使用者自行承担。
- 请合理控制请求频率，遵守目标网站的 robots.txt 及相关使用规则。
...
|      thread      |   _无_   | 可选 |        (int)5        |                                                            线程数，建议设置为 `5` 或更低，过高可能造成 HTTP429 错误                                                             |
